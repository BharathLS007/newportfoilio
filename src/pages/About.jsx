...
<div className="content-right">
  <h1>Know Who <span className='highlight'>I Am</span></h1><br />
  <p style={{ fontSize: '1.3rem' }}>
    Hi Everyone, <span className='highlight'>I am Bharath L S</span> from <span className='highlight'>Kanyakumari</span>
  </p>
  <p style={{ fontSize: '1.3rem' }}>
    I recently completed my Bachelor's in Computer Science
  </p>
  <p style={{ fontSize: '1.3rem' }}>
    and Engineering from University College of Engineering, Nagercoil
  </p><br />
  <p style={{ fontSize: '1.3rem' }}>
    Apart from coding, some other activities that I love to do:
  </p><br />
  <p style={{ fontSize:'1.3rem', marginLeft:'20px' }}>
    <i className="fa-solid fa-hand-point-right"></i> Gaming
  </p><br />
  <p style={{ fontSize:'1.3rem', marginLeft:'20px' }}>
    <i className="fa-solid fa-hand-point-right"></i> Reading Books
  </p><br />
  <p style={{ fontSize:'1.3rem', marginLeft:'20px' }}>
    <i className="fa-solid fa-hand-point-right"></i> Travelling
  </p><br />
</div>
